                ...
                <div class="box box-danger">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <a class="btn btn-danger btn-xs" href="<?= site_url('simpel-aja/poli') ?>"><i class="fa fa-reply"></i> Kembali</a>
                        </div>
                    </div>
                    <div class="box-body">
                        <div class="">
    ...
    document.onreadystatechange = () => {
        if (document.readyState === "complete") {
            ...
            $(document).on('click', '#detail', function() {
                ...
                $.get(site_url + 'simpel-aja/poli/detail_dokter/' + id_user, function(html) {
                    $('#myModal').html(html);
                    $('#myModal').modal('show');
                });
            });
