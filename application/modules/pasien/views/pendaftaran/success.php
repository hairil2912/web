            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box-body box-profile">
                        <img class="profile-user-img img-responsive img-circle" src="<?= base_url('assets/success-icon-2.png'); ?>" alt="User profile picture">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <a href="<?= site_url('pasien/antrian') ?>" class="btn btn-info btn-sm data-pasien-igd"><i class="fa fa-list"></i> Lihat Antrian</a>
                                </div>
                            </div>
                        </div>
                    </div>
