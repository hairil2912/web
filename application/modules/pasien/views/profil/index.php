                    ...
                    <div class="box-body">
                        ...
                        <div class="tab-content no-padding">
                            <div class="tab-pane active" role="tabpanel" id="biodata">
                                <form class="forms-sample" action="<?= site_url('pasien/profil/update'); ?>" method="POST" id="from_update">
                            ...
                            <div class="tab-pane" role="tabpanel" id="pass">
                                <form class="forms-sample" action="<?= site_url('pasien/profil/ganti_pin'); ?>" method="POST" id="from_pin">
                                    <input type="hidden" name="id_user" value="<?= @$user->id_user?>">
                                    <div class="box-body">
                                        <div class="form-group">
        ...
        if (document.readyState === "complete") {
            ...
            App.save('#from_update', function () {}, function (response) {
                if (response.status === true) {
                    setTimeout(function(){ 
                        window.location.replace("<?= site_url('pasien/profil')?>");
                    }, 1000);
                }
            });
