...
<main class="main">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="#">Spesialis</a></li>
    <li class="breadcrumb-item active">All Spesialis</li>
  </ol>
    ...
    <div class="row">
      <div class="col-md-12">
          <div class="page-title">
            <h4>All Spesialis</h4><a href="<?= site_url('admin/spesialis/create') ?>" class="btn btn-sm btn-success">Add New</a>
          </div>
      </div>
    </div>
          ...
          <!-- <div class="card">
            <div class="card-body"> -->
              <table style="background: white" class="table table-responsive-sm table-striped table-bordered">
                ...
                <tbody>
                  <?php foreach($spesialis as $page): ?>
                    <tr>
                      <td>
                        <?= $page->title ?>
                        <br>
                          <?php if($page->status != 'trash'): ?>
                            <span><a href="<?= site_url('admin/spesialis/create/'. $page->post_id) ?>"><i class="fa fa-edit"> Edit</i></a></span> <span class="separator">|</span>
      ...
      $('.trash').click(function(){
        ...
        alertify.confirm('<i class="fa fa-info-circle"></i> Confirm', 'Are you sure want to delete the data?', function(){ 
          ...
          $.ajax({
            ...
            url: '<?= site_url('admin/spesialis/trash') ?>',
            dataType: 'json',
      ...
      $('.restore').click(function(){
        ...
        alertify.confirm('<i class="fa fa-info-circle"></i> Confirm', 'Are you sure want to restore the data?', function(){ 
          ...
          $.ajax({
            ...
            url: '<?= site_url('admin/spesialis/restore') ?>',
            dataType: 'json',
            success: function(response){
              if (response.status === true) {
                tr.hide();
      ...
      $('.delete').click(function(){
        ...
        alertify.confirm('<i class="fa fa-info-circle"></i> Confirm', 'Are you sure want to permanently delete the data?', function(){ 
          ...
          $.ajax({
            ...
            url: '<?= site_url('admin/spesialis/delete') ?>',
            dataType: 'json',
            success: function(response){
