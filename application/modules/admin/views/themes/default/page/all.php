    ...
    <div class="row">
      <div class="col-md-12">
          <div class="page-title">
            <h4>All Pages</h4><a href="<?= site_url('admin/page/create') ?>" class="btn btn-sm btn-success">Add New</a>
          </div>
      </div>
    </div>
                      ...
                      <td>
                        ...
                        <br>
                          <?php if($page->status != 'trash'): ?>
                            <span><a href="<?= site_url('admin/page/create/'. $page->post_id) ?>"><i class="fa fa-edit"> Edit</i></a></span> <span class="separator">|</span>
      ...
      $('.restore').click(function(){
        ...
        alertify.confirm('<i class="fa fa-info-circle"></i> Confirm', 'Are you sure want to restore the data?', function(){ 
          ...
          $.ajax({
            ...
            url: '<?= site_url('admin/page/restore') ?>',
            dataType: 'json',
            success: function(response){
              if (response.status === true) {
                tr.hide();
      ...
      $('.delete').click(function(){
        ...
        alertify.confirm('<i class="fa fa-info-circle"></i> Confirm', 'Are you sure want to permanently delete the data?', function(){ 
          ...
          $.ajax({
            ...
            url: '<?= site_url('admin/page/delete') ?>',
            dataType: 'json',
            success: function(response){
              if (response.status === true) {
                tr.hide();
