...
class Ajax_pagination{
    ...
    var $full_tag_open = '<center><ul class="pagination pagination-sm">';
    var $full_tag_close = '</ul></center><!--pagination-->';
    ...
    var $cur_tag_open = '<li class="active"><a class="disabled" disabled href="javascript:void(0)">';
